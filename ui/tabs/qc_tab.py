...
from PyQt6.QtWidgets import (
    ...
    QLabel, QFrame, QTableView, QGroupBox, QScrollArea
)
...
class MetricCard(QFrame):
    ...
    def __init__(self, label: str, value: str = "", parent=None):
        ...
        self.label.setStyleSheet("color: #4A4540; font-size: 11px; background-color: transparent;")
        
        self.value_label = QLabel(value)
        self.value_label.setStyleSheet("color: #000000; font-size: 16px; font-weight: bold; background-color: transparent;")
...
class QCTab(QWidget):
    ...
    def _setup_ui(self):
        ...
        null_info = QLabel("✅ Common null values (-999.25, -9999, etc.) auto-replaced with NaN")
        ...
        # Placeholder message
        self.placeholder = QLabel("👈 Please load a LAS file using the sidebar to begin.")
    ...
    def update_display(self):
        ...
        self.depth_range_card.set_value(f"{qc.depth_range[0]:.1f} - {qc.depth_range[1]:.1f}")
